...
DICT_WEBQSP = '../data/webqsp_data/CSQA_result_question_type_944K.json'
DICT_WEBQSP_WEAK = '../data/webqsp_data/CSQA_result_question_type_count944K.json'
...
if __name__ == "__main__":
    ...
    sys.argv = ['train_1st_maml_true_reward_webqsp.py', '-l=../data/saves/webqsp/rl_even_adaptive_1%_att=1/truereward_0.614_00.dat',
                '-n=maml_att=0_newdata2k_1storder1', '--cuda', '-s=5', '-a=0', '--att=0', '--lstm=1', '--fast-lr=0.1',
