...
def retriever_training(epoches):
    ...
    # positive_document_list = [[700001-700000, 700002-700000, 900000-700000, 910000-700000, 944000-2-700000],
    #                           [2, 3],
