...
if __name__ == "__main__":
    ...
    sys.argv = ['train_crossent.py', '--cuda', '-l=../data/saves/crossent_attention_even/pre_bleu_0.662_01.dat', '-n=rl_attention_even']
    ...
    with ptan.common.utils.TBMeanTracker(writer, batch_size=100) as tb_tracker:
        ...
        for epoch in range(MAX_EPOCHES):
            ...
            for batch in data.iterate_batches(train_data, BATCH_SIZE):
                ...
                input_seq, input_batch, output_batch = attention_model.pack_batch_no_out(batch, net.emb, device)
                input_seq = input_seq.cuda()
                # Get (two-layer) hidden state of encoder of samples in batch.
                out, enc = net.encode(input_seq)
