...
if __name__ == "__main__":
    ...
    sys.argv = ['data_test.py', '-m=pre_bleu_0.662_01.dat', '-p=sample_final', '--n=rl_attention_even']
    ...
    net = attention_model.PhraseModel(emb_size=attention_model.EMBEDDING_DIM, dict_size=len(emb_dict), hid_size=attention_model.HIDDEN_STATE_SIZE)
    net = net.cuda()
    ...
    for seq_1, targets in train_data:
        ...
        input_seq = attention_model.pack_input(seq_1, net.emb)
